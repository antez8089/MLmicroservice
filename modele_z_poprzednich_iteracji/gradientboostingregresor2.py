...
class GlobalModel:
    ...
    def prepare_data(self, target_date):
        ...
        week_offsets = [1, 2, 3, 4, 5, 6]  # Define week offsets
    ...
    def train(self, target_date):
        ...
        start_date = target_date - pd.Timedelta(weeks=110)
        ...
        while current_date < target_date:
            ...
            feature_columns = [col for col in data.columns if col.startswith("play_count_week") and not col.startswith("play_count_week1")]
...
if __name__ == "__main__":
    ...
    model.train("2024-12-01")
    predictions = model.predict("2024-10-08")
    model.save("global_model_2.pkl")
